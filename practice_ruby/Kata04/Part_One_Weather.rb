  ...
  # create 1 array with 2 sub hashes for min and max temps
  temps= [
  max_temp = {
    1 => 88,
    2 => 79,
...
# calculate diffrence of corresponding min/max and push into new hash with corresponding days
temp_difference = max_temp.merge(min_temp){ |k, max_temp_value, min_temp_value| max_temp_value - min_temp_value}


# sort hash by lowest temp difference
temp_difference_sort = temp_difference.sort_by {|_key, value| value}.to_h

# display
p "The smallest temperature difference for Morristown, NJ, was on June #{temp_difference_sort.keys[0]}, 2002, where the temperature changed #{temp_difference_sort.values[0]} degrees that day."